use gpui::{
    Application, Background, Bounds, ColorSpace, Context, MouseDownEvent, Path, PathBuilder, PathStyle, Pixels, Point, Render, StrokeOptions, Window, WindowOptions, canvas, div, linear_color_stop, linear_gradient, point, prelude::*, px, rgb, size,
};
...
impl PaintingViewer {
    fn new(_window: &mut Window, _cx: &mut Context<Self>) -> Self {
        ...
        builder.translate(point(px(10.0), px(100.)));
        builder.scale(0.9);
        ...
        builder.move_to(point(px(370.), px(160.)));
        builder.move_to(point(px(430.), px(160.)));
        builder.move_to(point(px(380.), px(200.)));
        builder.move_to(point(px(400.), px(260.)));
        builder.move_to(point(px(350.), px(220.)));
        builder.move_to(point(px(300.), px(260.)));
        ...
        lines.push((
            ...
            linear_gradient(
                ...
                linear_color_stop(rgb(0xD56D0C), 0.1),
            )
        ...
        lines.push((
            ...
            linear_gradient(
                ...
                linear_color_stop(gpui::red(), 0.1),
            )
        ));
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .justify_between()
                    .items_center()
                    .child("Mouse down any point and drag lines (Hold on shift key to draw straight lines)")
                    .child(
                        div()
                            .id("clear")
                            .child("Clean up")
