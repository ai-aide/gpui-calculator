use gpui::{
    div, prelude::*, px, rgb, size, App, Application, Bounds, Context, SharedString, Timer, Window, WindowBounds, WindowKind, WindowOptions
};
...
impl Render for WindowDemo {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        let window_bounds = WindowBounds::Windowed(Bounds::centered(None, size(px(300.), px(300.)), cx));
